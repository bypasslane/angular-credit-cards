  ...
  exports.formattedParse = function(number) {
    ...
    for (var typeName in exports.types) {
      ...
      if(type.quickPattern.test(parsed)) {
        ...
        var formatNumber = function (/*, args */) {
          var splatArgs = Array.prototype.slice.call(arguments, formatNumber.length);
          var matches = splatArgs.slice(1, splatArgs.length - 2);
...
},{"bp-creditcards":6}],8:[function(require,module,exports){
  (function (global){
    'use strict';
...
},{"./cvc":7,"./expiration":8,"./number":10,"bp-creditcards":6}],10:[function(require,module,exports){
  'use strict';
